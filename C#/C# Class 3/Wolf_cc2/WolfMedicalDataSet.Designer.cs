...
namespace Wolf_cc2.WolfMedicalDataSetTableAdapters {
...
SELECT doctorID, name, office, email, hire_date FROM doctors WHERE (doctorID = @doctorID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Wolf_cc2.Properties.Settings.Default.WolfMedicalConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO doctors\r\n                         (name, office, email, hire_date)\r\nV" +
                "ALUES        (@name,@office,@email,@hire_date); ";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@name", global::System.Data.SqlDbType.NChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@office", global::System.Data.SqlDbType.NChar, 30, global::System.Data.ParameterDirection.Input, 0, 0, "office", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@hire_date", global::System.Data.SqlDbType.DateTime, 8, global::System.Data.ParameterDirection.Input, 0, 0, "hire_date", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int InsertQuery(string name, string office, string email, System.DateTime hire_date) {
            ...
            if ((office == null)) {
                ...
                command.Parameters[1].Value = ((string)(office));
            }
            if ((email == null)) {
                throw new global::System.ArgumentNullException("email");
            }
            ...
            command.Parameters[3].Value = ((System.DateTime)(hire_date));
