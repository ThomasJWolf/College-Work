...
namespace Wolf_cc1.WolfMedicalDataSetTableAdapters {
...
SELECT patientID, name, address, phone, email, deductible_limit FROM patients WHERE (patientID = @patientID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Wolf_cc1.Properties.Settings.Default.WolfMedicalConnectionString;
        }
