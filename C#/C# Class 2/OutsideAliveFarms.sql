...
--
-- Host: localhost:3306
-- Generation Time: Nov 04, 2023 at 10:46 PM
...
--
ALTER TABLE `Inventory`
  ADD CONSTRAINT `Inventory_ibfk_1` FOREIGN KEY (`AlbumKey`) REFERENCES `Plants` (`AlbumKey`) ON UPDATE CASCADE;
