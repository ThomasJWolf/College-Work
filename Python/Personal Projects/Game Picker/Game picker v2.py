# Game picker
# This program will help people pick games based on some dictionaries, this is v2.
# Thomas Wolf
# 11/30/22
...
def compare():
    ...
    go_again=validate.alpha_check("Would you like to go again?(yes or no)","\nPlease enter yes or no")
