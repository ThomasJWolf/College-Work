...
module.exports = function (con, bcrypt) {
  ...
  router.get("/getsingleprch/", function (req, res) {
    ...
    var twpkey = req.query.twupprchkey;
  ...
  router.post("/updatesingleprch", function (req, res) {
    var twpid = req.body.twuppurchaseid;
    var twpammount = req.body.twuppurchaseammount;
    var twpdate = req.body.twuppurchasedate;
    var twpuser = req.body.twuppurchaseuser;
    var twpplayer = req.body.twuppurchaseplayer;
