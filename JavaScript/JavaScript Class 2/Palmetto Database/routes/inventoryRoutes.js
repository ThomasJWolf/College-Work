...
module.exports = function (con, bcrypt) {
  ...
  router.get("/getsingleinvt/", function (req, res) {
    var twikey = req.query.twupinvtid;
  ...
  //
  // ----------------- Update Single Inventories (update) -----------------

  router.post("/updatesingleinvt", function (req, res) {
    console.log(req.body);
    var twiid = req.body.twupinventoryid;
    var twiproduct = req.body.twupinventoryproduct;
    var twiinstock = req.body.twupinventoryinstock;

    console.log(twiid + " " + twiproduct + " " + twiinstock);

    var sqlins =
      "UPDATE Inventory SET InventoryInStock = ?, InventoryLastUpdated = NOW() , ProductID = ? WHERE InventoryID = ?";
  ...
  router.post("/inventory", function (req, res) {
    ...
    var sqlins =
      "INSERT INTO Inventory (InventoryInStock, ProductID, InventoryLastUpdated) VALUES (?, ?, NOW())";
