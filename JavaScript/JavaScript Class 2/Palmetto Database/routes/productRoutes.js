...
module.exports = function (con, bcrypt) {
  ...
  router.post("/updatesingleprod", function (req, res) {
    var twpid = req.body.twupproductid;
    var twpname = req.body.twupproductname;
    var twpprice = req.body.twupproductprice;
    var twpcategory = req.body.twupproductcategory;
