...
module.exports = function (con, bcrypt) {
  ...
  router.post("/updatesingleprchdtl", function (req, res) {
    var twpid = req.body.twuppurchasedetailid;
    var twpproduct = req.body.twuppurchasedetailproduct;
    var twppurchase = req.body.twuppurchasedetailpurchase;
    var twpquantity = req.body.twuppurchasedetailquantity;

    var sqlins =
      "UPDATE PurchaseDetail SET PurchaseQuantity = ?, ProductID = ?, PurchaseID = ? WHERE PurchaseDetailID = ?";
    var inserts = [twpquantity, twpproduct, twppurchase, twpid];
