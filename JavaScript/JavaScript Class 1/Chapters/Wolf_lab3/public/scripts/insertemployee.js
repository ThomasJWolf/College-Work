...
//This creates an object class named EmplyoeeBox
var EmplyoeeBox = React.createClass({
  render: function () {
    //we list emplyoees, then show the form for new emplyoees
    //EmplyoeeForm calls the object created below on line 66.
    return (
      <div className="emplyoeeBox">
        <h1>Emplyoees</h1>
        <Emplyoeeform2 />
      </div>
    );
...
var Emplyoeeform2 = React.createClass({
  ...
  render: function () {
    ...
    return (
      ...
      <form className="emplyoeeForm" onSubmit={this.handleSubmit}>
        <h2>Emplyoees</h2>
        <table>
          <tbody>
            <tr>
              ...
              <td>
                <TextInput
                  value={this.state.emplyoeename}
                  uniqueName="emplyoeename"
                  textArea={false}
                  required={true}
                  minCharacters={6}
                  validate={this.commonValidate}
                  onChange={this.setValue.bind(this, 'emplyoeename')}
                  errorMessage="Emplyoee Name is invalid"
                  emptyMessage="Emplyoee Name is required" />
              </td>
            </tr>
            <tr>
              ...
              <td>
                <TextInput
                  value={this.state.emplyoeeaddress}
                  uniqueName="emplyoeeaddress"

                  textArea={false}
                  required={false}
                  minCharacters={6}
                  validate={this.commonValidate}
                  onChange={this.setValue.bind(this, 'emplyoeeaddress')}
                  errorMessage="Emplyoee Address is invalid" />
              </td>
            </tr>
            <tr>
              <th>Emplyoee Zip</th>
              <td>
                <TextInput
                  value={this.state.emplyoeezip}
                  uniqueName="emplyoeezip"
                  textArea={false}
                  required={false}
                  validate={this.commonValidate}
                  onChange={this.setValue.bind(this, 'emplyoeezip')}
                  errorMessage=""
                  emptyMessage="" />
              </td>
            </tr>
            <tr>
              <th>Emplyoee Credit Limit</th>
              <td>
                <TextInput
                  value={this.state.emplyoeecredit}
                  uniqueName="emplyoeecredit"
                  textArea={false}
                  required={false}
                  minCharacters={6}
                  validate={this.validateDollars}
                  onChange={this.setValue.bind(this, 'emplyoeecredit')}
            ...
            <tr>
              ...
              <td>
                <TextInput
                  value={this.state.emplyoeeemail}
                  uniqueName="emplyoeeemail"
                  textArea={false}
                  required={true}
                  minCharacters={6}
                  validate={this.validateEmail}
                  onChange={this.setValue.bind(this, 'emplyoeeemail')}
...
//This code renders the EmplyoeeBox object we created up at the top of the page onto the screen.
