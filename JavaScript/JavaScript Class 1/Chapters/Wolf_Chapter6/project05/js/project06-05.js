...
window.addEventListener("load", function () {
   ...
   //FIX: Use "onclick" instead of "click"
   // Verify that the user has selected a session to attend
   document.getElementById("regSubmit").onclick = sessionTest;

   //FIX: Use "onblur" instead of "blur" and "onchange" instead of "change" and "onclick" instead of "click"
...
function sessionTest() {
   ...
   //FIX: Use "setCustomValidity" instead of "setValidity"
...
function calcCart() {
   ...
   //FIX: Use "selectedIndex" instead of "index"
   ...
   //FIX: Use "checked" instead of "check"
   ...
   //FIX: Use proper object structure for toLocaleString options
