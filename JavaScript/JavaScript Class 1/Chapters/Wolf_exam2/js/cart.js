...
function displayCart() {
   ...
   if (sessionStorage.getItem("itemsInCart")) {
      ...
      for (let i = 1; i <= itemTotal; i++) {
         ...
         let productArr = sessionStorage.getItem("cartItem" + i);
         ...
         productCell.textContent = productArr;
         ...
         descriptionCell.textContent = productArr + ", " + productArr;
         ...
         qtyCell.textContent = productArr;
         ...
         priceCell.textContent = productArr;
