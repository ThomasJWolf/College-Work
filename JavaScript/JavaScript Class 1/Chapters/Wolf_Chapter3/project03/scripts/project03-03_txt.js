...
//Creates an empty string variable as htmlCode
let htmlCode = "";

//For every time i is less than titles.length, repeat
for (let i = 0; i < titles.length; i++) {
      // Add the movie raiting wrapped in HTML tags
      htmlCode += "<tr>";
...
window.addEventListener("DOMContentLoaded", function () {
      //Get the first tbody element in the document and Populate the tbody with the HTML code
